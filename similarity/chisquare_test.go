...
var chiSquareUint8Tests = []struct {
	...
	{"simple case", hashtype.UInt8{10, 20, 30}, hashtype.UInt8{15, 25, 35}, similarity.Distance(1.9401709401709402)},
	{"with zero pair", hashtype.UInt8{0, 20, 30}, hashtype.UInt8{0, 25, 35}, similarity.Distance(0.9401709401709402)},
	{"one zero", hashtype.UInt8{0, 10}, hashtype.UInt8{5, 10}, similarity.Distance(5)},
}

func TestChiSquareUint8(t *testing.T) {
	for _, tt := range chiSquareUint8Tests {
		t.Run(tt.name, func(t *testing.T) {
			res, err := similarity.ChiSquare(tt.hash1, tt.hash2)
			if err != nil {
...
var chiSquareFloat64Tests = []struct {
	...
	{"same hashes", hashtype.Float64{1.0, 2.0, 3.0}, hashtype.Float64{1.0, 2.0, 3.0}, similarity.Distance(0)},
	{"simple case", hashtype.Float64{1.0, 2.0, 3.0}, hashtype.Float64{2.0, 3.0, 4.0}, similarity.Distance(0.6761904761904762)},
	{"both zeros skipped", hashtype.Float64{0.0, 2.0}, hashtype.Float64{0.0, 4.0}, similarity.Distance(0.6666666666666666)},
}
